...
const assets = {
  svg: {
    ...
    more: (
      <svg viewBox="0 0 24 24" className="w-4 fill-current">
        <g>
...
function Header() {
  return (
    <div className="flex items-center justify-between px-4 py-2 border-b border-gray-200">
      <div className="text-xl font-black">Trends For You</div>
...
function Trend() {
  return (
    <div className="px-4 py-3 border-b border-gray-200 cursor-pointer last:border-transparent hover:bg-gray-200">
      <div className="flex items-center justify-between">
        <div className="text-xs text-gray-500">Trending in Indonesia</div>
        <div className="-m-2">
          <LightButton className="hover:text-blue-400 hover:bg-blue-100">
            {assets.svg.more}
          </LightButton>
        </div>
      </div>
      <div className="font-bold">Kimia Farma</div>
      <div className="mt-1 text-xs text-gray-500">5,924 Tweets</div>
    </div>
  )
}
